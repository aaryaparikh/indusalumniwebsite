...
{
    $sql = "INSERT INTO faculty (f_name,m_name,l_name,email ,contact,register,qualification,department,U_ID,pass) VALUES ('".$_POST['fname']."', '".$_POST['mname']."','".$_POST['lname']."','".$_POST['email']."','".$_POST['contact']."','".$_POST['register_as']."','".$_POST['qualification']."','".$_POST['department1']."','".$_POST['u_id']."','".$_POST['pass']."')";
}
